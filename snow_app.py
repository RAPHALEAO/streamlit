...
rows = run_query("SELECT COUNT(1) AS QTDE, TO_VARCHAR(YEAR(DATAHORA)) AS YEAR, ID_DATABASE FROM PEDIDOS WHERE YEAR(DATAHORA) = 2021 GROUP BY ID_DATABASE, YEAR(DATAHORA) ORDER BY QTDE DESC LIMIT 10")
